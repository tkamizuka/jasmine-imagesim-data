...
if __name__ == '__main__':
    ...
    filenames['ctljson'] = os.path.join(dirname_params, "ctl2.json")
    filenames['acex']    = os.path.join(dirname_params, "acex.fits")
    filenames['acey']    = os.path.join(dirname_params, "acey.fits")
    ...
    if control_params.effect.ace == 'real_no_lag':
        ...
        acex_fits = fits.open(filenames['acex'])[0]
        acey_fits = fits.open(filenames['acey'])[0]
        acex = acex_fits.data
        acey = acey_fits.data
    ...
    if control_params.effect.ace == 'gauss':
    ...
    elif control_params.effect.ace == 'real_no_lag':
        ...
        for iplate in range(0, control_params.nplate):
            ...
            h, x, y = np.histogram2d(
                ...
                bins=np.arange(-101, 101)+0.5, density=True)
