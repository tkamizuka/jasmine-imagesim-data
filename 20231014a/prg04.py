...
def convert_fits(input_file, conversion_factor, flatdata, output_file):
    try:
        # FITSファイルを読み込み
...
if __name__ == "__main__":
    ...
    inputdir = "02_results/"
    outputdir = "05_flattened/"
    flatdata = fits.open("02_results/interpix.fits")[0].data.T
    for mag in mags:
        for iplate in range(0,11):
            ...
            for bit in bits:
                ...
                convert_fits(inputfile, convf, flatdata, outputfile)
#    if len(sys.argv) != 4:
